...
namespace CPW211_MurderMystery.Migrations
{
    ...
    [Migration("20240312211921_Update1")]
            ...
            modelBuilder.Entity("CPW211_MurderMystery.Player", b =>
                {
                    ...
                    b.ToTable("Players", t =>
                        {
                            t.HasCheckConstraint("CK_GenderPreference", "[GenderPreference] IN ('Male', 'Female', 'No Preference')");

                            t.HasCheckConstraint("CK_PlayerName", "[PlayerName] NOT LIKE '%[^a-zA-Z0-9 ]%'");
                        });
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PlayerName = "Person Two"
                        },
                        new
                        {
                            PlayerId = 3,
                            GenderPreference = "No Preference",
                            PlayerName = "User Three"
                        },
                        new
                        {
                            PlayerId = 4,
                            GenderPreference = "Female",
                            PlayerName = "Attendee 4"
                        },
                        new
                        {
                            PlayerId = 5,
